...
<html>
<head>
<title>Maintanance | {{ config('app.name', 'Laravel') }}</title>
...
<main>
  ...
  <h1>{{ @$maintenance->message ?? "We're under maintenance" }}</h1>
  <h2>Sorry for the inconvenience. We will get back soon!</h2>
